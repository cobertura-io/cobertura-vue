    ...
    <div class="row">
      <div class="col s7">
        <div class="welcome">
          ...
          <img src="src/assets/sofa.png" alt="ilustração de um sofá" width="500" class="sofa">
          <div class="copyright">
      ...
      <div class="col s5 login-form">
        <div class="container">
          <div class="login-logo">
            <a href="/">
            <img src="src/assets/logo_colored.png" alt="Logo do Cobertura" width="250">
            </a>
          </div>
